...
hence $$|C| = |C'|$$, implying that $$C$$ is a conjugacy class of $$A_n$$.
...
thus $$|C_i| = |C|/2$$, and since the conjugacy classes are disjoint, this implies that $$C = C_1 \cup C_2$$, where $$C_1,C_2$$ are conjugacy classes of $$A_n$$.
